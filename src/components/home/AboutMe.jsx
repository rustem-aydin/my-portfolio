      ...
      <div className="px-5 py-8 md:p-8 backdrop-blur-[2px] dark:bg-opacity-80 bg-white dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13">
        ...
        <div className="mt-7 md:mt-10 section-title">
          ...
          <p className="max-w-2xl mt-4 md:mt-6 subtitle">
            ...
            <br />
            Geliştirme yaparken en çok; detaylara olan hassasiyetim, bir şeyler
            üretmekten aldığım gerçek keyif ve hedefime ulaşana kadar pes
            etmeyen yapım beni motive eder. Web veya mobil fark etmeksizin,
            ortaya gerçekten kaliteli bir iş çıkarmak için çalışmayı seviyorum.
          </p>
        </div>
