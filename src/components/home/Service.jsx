...
const Service = () => {
  return (
    ...
    >
      <div className="px-5 py-8 md:p-8 backdrop-blur-[2px] bg-opacity-80 dark:bg-opacity-80 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
