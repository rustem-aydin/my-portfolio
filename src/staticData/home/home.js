...
import { GrGoogle, GrTasks } from "react-icons/gr";
import {
  BiBrain,
  BiCheckDouble,
  BiCommentCheck,
...
import { IoHomeOutline, IoLogoDesignernews, IoMapSharp } from "react-icons/io5";
import { CiMobile1 } from "react-icons/ci";
import { LiaGoogle, LiaMapSolid } from "react-icons/lia";
import WebDevMini, {
  WebDevIconMini,
} from "@/src/components/icons/home/WebDevMini";
import SeoIconMini from "@/src/components/icons/home/SeoIconMini";
import UiUxIconMini from "@/src/components/icons/home/UiUxMini";
import BrandingIconMini from "@/src/components/icons/home/BrandingMin";
...
export const introduce = {
  ...
  desc: (
    <p>
      MERN Stack, Next.js ve React Native teknolojileriyle web ve mobil
      uygulamalar geliştiren bir Full-Stack Developer’ım. Üretmeye olan tutkumu,
      detaylara verdiğim önemi ve çözüm odaklı çalışma disiplinimi bir araya
      getirerek; hızlı, ölçeklenebilir ve kullanıcı odaklı dijital ürünler
      oluşturuyorum.
    </p>
  ),
  jobs: [
    {
      ...
      icon: <WebDevMini className="text-theme mr-1 max-w-2" />,
    },
    {
      id: 2,
      title: "Mobil Geliştirme",
      icon: <CiMobile1 size={25} className="text-theme mr-1" />,
    },
    {
      id: 3,
      title: "UI/UX Tasarımı",
      icon: <UiUxIconMini size={25} className="text-theme mr-1" />,
    },
    {
      id: 4,
      title: "n8n / AI Automation",
      icon: <BiBrain size={25} className="text-theme mr-1" />,
    },
    {
      id: 5,
      title: "SEO & Dijital Pazarlama",
      icon: <SeoIconMini className="text-theme mr-1" />,
    },
    {
      id: 6,
      title: "Reklam ve Analiz",
      icon: <BrandingIconMini size={25} className="text-theme mr-1" />,
    },
    ,
    {
      id: 6,
      title: "Google/Yandex Haritalar",
      icon: <FaMapSigns size={25} className="text-theme mr-1" />,
    },
  ],
};
  ...
  servicesData: [
    {
      ...
      number: "01",
      title: "Web Geliştirme",
      desc: "React, Next.js ve modern web teknolojileri ile hızlı, güvenli ve tüm cihazlara uyumlu profesyonel web siteleri ve web uygulamaları geliştiriyorum.",
      icon: <WebDevIcon />,
    },
    {
      id: 2,
      ...
      desc: "React Native ve Expo ile yüksek performanslı, modern ve tüm cihazlara optimize edilmiş mobil uygulamalar geliştiriyorum.",
      icon: <CiMobile1 className="size-10 fill-theme" />,
    },
    {
      id: 3,
      number: "03",
      title: "UI/UX Tasarımı",
      desc: "Kullanıcı odaklı, modern ve estetik arayüzler tasarlayarak markanızı etkileyici bir dijital deneyime dönüştürüyorum.",
      icon: <UiUxIcon />,
    },
    {
      id: 4,
      ...
      desc: "n8n ve yapay zeka teknolojileriyle iş süreçlerinizi otomatikleştiriyor, size zaman ve maliyet tasarrufu sağlayan akıllı iş akışları oluşturuyorum.",
    ...
    },
    {
      ...
      number: "05",
      title: "SEO & Dijital Pazarlama",
      desc: "Arama motoru odaklı içerik, teknik SEO ve hedefli dijital pazarlama stratejileri ile markanızın çevrimiçi görünürlüğünü artırıyorum.",
      icon: <SeoIcon />,
    },
    {
      id: 6,
      number: "06",
      title: "Reklam ve Analiz",
      desc: "Markanızı dijital dünyada güçlü bir kimlikle konumlandıracak reklam yönetimi, analitik takip ve stratejik içerik çözümleri sunuyorum.",
      icon: <BrandingIcon />,
    },
    {
      id: 7,
      number: "07",
      title: "Google & Yandex Haritalar",
      desc: "Google Maps ve Yandex Maps’e işletme kaydı yaparak müşterilerinizin sizi kolayca bulmasını sağlıyor, harita görünürlüğünüzü ve bölgesel erişiminizi artırıyorum.",
      icon: <FaMapSigns className="size-10 fill-theme" />,
    },
  ],
};
